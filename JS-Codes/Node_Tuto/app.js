...
app.get('/', function(req, res) {
	...
	res.render('index.ejs', {message: req.flash('error'), page_title: 'Main Page', 
			tasks: tasksList, authenticated: false, actual_user: 'Alex', signup: false});
})
/*
...
.get('/todo', ensureAuthenticated, function(req, res) {
	...
	res.render('index.ejs', {page_title: 'Todo List', tasks: tasksList, authenticated: true, 
		actual_user: 'Alex', signup: false});
})
.get('/signup', function(req, res) {
	var signup = true;
	var tasksList = null;
	res.render('index.ejs', {page_title: 'Sign Up', tasks: tasksList, authenticated: false, 
		actual_user: 'Alex', signup: true});
});
